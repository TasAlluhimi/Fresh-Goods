...
<div className='text-7xl h-fit w-[40rem] max-sm:w-[100%] max-sm:text-6xl' style={{ overflow: 'hidden' }}>End with one final call to action</div>
<div className='mt-20 text-3xl w-[60%] max-sm:w-[90%] max-sm:text-2xl' style={{ overflow: 'hidden' }}>This is your last shot at converting someone. Remind them about the benefits of your offer and encourage them to act now.</div>
